...
/// </summary>
/// <remarks>
/// This handler retrieves all active (non-delivered) orders for the given table, marks them as paid, and
/// returns the total amount due. If no active orders are found, the operation fails. After finalization, it dispatches
/// notifications to coordinate further actions in the restaurant workflow.
/// </remarks>
...
internal sealed class FinalizeTableHandler(OrderingDbContext db, IOrderingDispatcher dispatcher) : IUseCaseHandler<FinalizeTableOrderUseCase, Result<decimal>>
{
    ...
    {
        // 1. Audit Entry
        // [cite: 2026-01-29]: All log lines must include a datetime.
        ...
        // Ensure Microsoft.EntityFrameworkCore is referenced in the project to use ToListAsync.
        ...
        // 4. Dispatch: Orchestrate the next steps in the restaurant
        // [cite: 2026-01-08]: Dispatcher is generated even if no usecases or events exist.
